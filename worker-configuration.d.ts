/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 881ea18fe50cf39cddfec07a573187d6)
...
interface __BaseEnv_Env {
	...
	LGU_ENV: "production";
	LGU_AUTH_HOST: "lgu-auth.rich-group.kr";
	LGU_SEND_HOST: "lgu-send.rich-group.kr";
	LGU_CONTENT_HOST: "lgu-file.rich-group.kr";
	SMS_GATEWAY_API_URL: "https://sms-api.rich-group.kr/api/3rdparty/v1";
	SMS_GATEWAY_MOBILE_URL: "https://sms.rich-group.kr/api/mobile/v1";
	WORKS_CLIENT_ID: "V6MgQwNfZoK8fnESzNZy";
	WORKS_ISSUER: "https://auth.worksmobile.com";
	WORKS_TENANT_ID: "300285491";
	CF_ACCESS_CLIENT_ID: string;
	CF_ACCESS_CLIENT_SECRET: string;
	LGU_API_KEY: string;
	LGU_API_PASSWORD: string;
	LGU_MO_WEBHOOK_SECRET: string;
	LGU_REPORT_WEBHOOK_SECRET: string;
	SMS_GATEWAY_PASSWORD: string;
	SMS_GATEWAY_SIGNING_KEYS: string;
	SMS_GATEWAY_USERNAME: string;
	WORKS_CLIENT_SECRET: string;
	OFFICE_HUB: DurableObjectNamespace<import("./worker/index").OfficeHub>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "OfficeHub";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEV_LOGIN_ENABLED" | "LGU_ENV" | "LGU_AUTH_HOST" | "LGU_SEND_HOST" | "LGU_CONTENT_HOST" | "SMS_GATEWAY_API_URL" | "SMS_GATEWAY_MOBILE_URL" | "WORKS_CLIENT_ID" | "WORKS_ISSUER" | "WORKS_TENANT_ID" | "CF_ACCESS_CLIENT_ID" | "CF_ACCESS_CLIENT_SECRET" | "LGU_API_KEY" | "LGU_API_PASSWORD" | "LGU_MO_WEBHOOK_SECRET" | "LGU_REPORT_WEBHOOK_SECRET" | "SMS_GATEWAY_PASSWORD" | "SMS_GATEWAY_SIGNING_KEYS" | "SMS_GATEWAY_USERNAME" | "WORKS_CLIENT_SECRET">> {}
}
